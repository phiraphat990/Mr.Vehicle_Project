    ...
    return (
        ...
        <Image style={styles.pic3} source={require("../assets/carbg2.png")}></Image> */}
            ...
            <View style={styles.view}>
                ...
                <Text style={{ fontWeight: "bold", paddingTop: 10,padding:10 }}>ข้อที่ ๑ ข้อมูลผู้เช่ายานพาหนะ</Text>
            ...
            <View style={styles.view}>
                <Text style={{ fontWeight: "bold", marginTop: 10,padding:10 }}>ข้อ ๒	ข้อตกลงเช่า</Text>
            ...
            <View style={styles.view}>
                <Text style={{ fontWeight: "bold", marginTop: 10,padding:10 }}>ข้อ ๓ ค่าเช่ายานพาหนะ</Text>

                <Text  style={{padding:10}}>
                    {" "}           ผู้เช่าตกลงชำระค่าเช่าให้แก่ผู้ให้เช่าเป็นรายวัน อัตราค่าเช่าตลอดทั้งการเช่ายานพาหนะ
                    ต่อยานพาหนะที่เช่าหนึ่งคันเป็นจำนวน {total} ซึ่งรวมภาษีมูลค่าเพิ่ม ภาษีอากรอื่น ๆ ค่าใช้จ่ายในการบำรุงรักษา ค่าภาษยานพาหนะ ค่าใช้จ่ายในการจัดทำประกันภัยยานพาหนะที่เช่า
